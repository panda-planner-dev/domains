...
;; (:htn :tasks (tlt)) ;; generic tlt
 (:htn :tasks (clear-road-hazard rochester-general park-ridge)) ;; org. tlt

 (:init
   (hazard-seriousness rochester-general park-ridge medium-hazardous)
   ...
   (atloc plow1 rochester-general)
   (atloc sleader3 airport)
   ...
   (atloc wtruck1 brighton-dump)
   (atloc bus1 brighton-high)
   (atloc wcrew1 brighton-dump)
   (atloc pdriver2 brighton-high)
   ...
   (atloc backhoe1 twelve-corners)
   (atloc ccrew1 twelve-corners)
