(define (problem transport1)
 ...
 (:objects
  ...
  ;;
  person-121967 - person
 )

;; (:htn :tasks (tlt)) ;; generic tlt
 (:htn :tasks (provide-medical-attention person-121967)) ;; org. tlt

 (:init
   (fit-in person-121967 plow2)
   (fit-in person-121967 plow1)
   (fit-in person-121967 ttruck1)
   (fit-in person-121967 pvan2)
   (fit-in person-121967 pvan1)
   (fit-in person-121967 van1)
   (fit-in person-121967 dtruck1)
   (fit-in person-121967 bus1)
   (fit-in person-121967 amb1)
   (fit-in person-121967 wtruck1)
   (fit-in person-121967 backhoe1)
   (can-lift emt1 person-121967)
   (has-condition person-121967 head-injury)
   (atloc food1 airport)
   (atloc food3 airport)
   (atloc food2 twelve-corners)
   (atloc pcrew1 strong)
   (atloc ttdriver1 texaco1)
   (atloc dtruck1 airport)
   (atloc emt1 rochester-general)
   (atloc pu2 brighton-dump)
   (atloc pu1 marketplace)
   (atloc bdriver1 mendon-pond)
   (atloc plow1 twelve-corners)
   (atloc sleader3 mendon-pond)
   (atloc sleader2 texaco1)
   (atloc gen1 mendon-pond)
   (atloc sleader1 mendon-pond)
   (atloc gen2 marketplace)
   (atloc plow2 rochester-general)
   (atloc amb1 rochester-general)
   (atloc van1 strong)
   (atloc person-121967 marketplace)
   (atloc wtruck1 texaco1)
   (atloc bus1 mendon-pond)
   (atloc wcrew1 texaco1)
   (atloc pdriver2 park-ridge)
   (atloc pdriver1 twelve-corners)
   (atloc ttruck1 texaco1)
   (atloc ht1 brighton-dump)
   (atloc tcrew1 texaco1)
   (atloc ht2 marketplace)
   (atloc tdriver1 airport)
   (atloc backhoe1 texaco1)
   (atloc ccrew1 texaco1)
   (atloc pvan2 brighton-dump)
