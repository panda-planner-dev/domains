...
;; (:htn :tasks (tlt)) ;; generic tlt
 (:htn :tasks (clear-road-tree twelve-corners marketplace)) ;; org. tlt

 (:init
   (fit-in tree-434041 dtruck1)   (can-lift ht2 tree-434041)   (can-lift ht1 tree-434041)   (can-lift pcrew1 tree-434041)   (can-lift tcrew1 tree-434041)   (can-lift wcrew1 tree-434041)   (can-lift ccrew1 tree-434041)   (tree-blocking-road twelve-corners marketplace tree-434041)
   (atloc tree-434041 twelve-corners)
   (atloc food1 texaco1)
   (atloc food3 pittsford-plaza)
   (atloc food2 rochester-general)
   (atloc pcrew1 brighton-high)
   (atloc ttdriver1 strong)
   (atloc dtruck1 henrietta-dump)
   (atloc emt1 texaco1)
   (atloc pu2 twelve-corners)
   (atloc pu1 henrietta-dump)
   (atloc bdriver1 texaco1)
   (atloc plow1 airport)
   (atloc sleader3 marketplace)
   (atloc sleader2 rochester-general)
   (atloc gen1 twelve-corners)
   (atloc sleader1 pittsford-plaza)
   ...
   (atloc pdriver2 mendon-pond)
   (atloc pdriver1 rochester-general)
   (atloc ttruck1 strong)
   (atloc ht1 mendon-pond)
   (atloc tcrew1 strong)
   (atloc ht2 airport)
   (atloc tdriver1 henrietta-dump)
   (atloc backhoe1 pittsford-plaza)
   (atloc ccrew1 pittsford-plaza)
   (atloc pvan2 twelve-corners)
