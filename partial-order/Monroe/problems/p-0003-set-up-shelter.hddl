...
;; (:htn :tasks (tlt)) ;; generic tlt
 (:htn :tasks (set-up-shelter marketplace)) ;; org. tlt

 (:init
   (atloc food1 henrietta-dump)
   (atloc food3 rochester-general)
   (atloc food2 texaco1)
   (atloc pcrew1 brighton-high)
   (atloc ttdriver1 twelve-corners)
   (atloc dtruck1 brighton-dump)
   (atloc emt1 texaco1)
   (atloc pu2 twelve-corners)
   (atloc pu1 strong)
   (atloc bdriver1 airport)
   (atloc plow1 twelve-corners)
   (atloc sleader3 rochester-general)
   (atloc sleader2 brighton-dump)
   ...
   (atloc ttruck1 twelve-corners)
   (atloc ht1 airport)
   (atloc tcrew1 twelve-corners)
   (atloc ht2 strong)
