(define (problem transport1)
 ...
 (:objects
  ...
  ;;
  person-272609 - person
 )

;; (:htn :tasks (tlt)) ;; generic tlt
 (:htn :tasks (provide-temp-heat person-272609)) ;; org. tlt

 (:init
   (fit-in person-272609 plow2)
   (fit-in person-272609 plow1)
   (fit-in person-272609 ttruck1)
   (fit-in person-272609 pvan2)
   (fit-in person-272609 pvan1)
   (fit-in person-272609 van1)
   (fit-in person-272609 dtruck1)
   (fit-in person-272609 bus1)
   (fit-in person-272609 amb1)
   (fit-in person-272609 wtruck1)
   (fit-in person-272609 backhoe1)
   (can-lift emt1 person-272609)
   (atloc food1 airport)
   (atloc food3 texaco1)
   (atloc food2 park-ridge)
   (atloc pcrew1 brighton-high)
   (atloc ttdriver1 henrietta-dump)
   (atloc dtruck1 brighton-dump)
   (atloc emt1 park-ridge)
   (atloc pu2 marketplace)
   (atloc pu1 henrietta-dump)
   (atloc bdriver1 twelve-corners)
   (atloc plow1 mendon-pond)
   (atloc sleader3 brighton-dump)
   (atloc sleader2 brighton-high)
   (atloc gen1 brighton-dump)
   (atloc sleader1 strong)
   (atloc gen2 brighton-dump)
   (atloc plow2 twelve-corners)
   (atloc amb1 park-ridge)
   (atloc van1 brighton-high)
   (atloc wtruck1 twelve-corners)
   (atloc bus1 twelve-corners)
   (atloc person-272609 pittsford-plaza)
   (atloc wcrew1 twelve-corners)
   (atloc pdriver2 henrietta-dump)
   (atloc pdriver1 brighton-high)
   (atloc ttruck1 henrietta-dump)
   (atloc ht1 texaco1)
   (atloc tcrew1 henrietta-dump)
   (atloc ht2 pittsford-plaza)
   (atloc tdriver1 brighton-dump)
   (atloc backhoe1 strong)
   (atloc ccrew1 strong)
   (atloc pvan2 marketplace)
   (atloc pvan1 henrietta-dump)
   ;;
