...
;; (:htn :tasks (tlt)) ;; generic tlt
 (:htn :tasks (fix-power-line brighton-dump)) ;; org. tlt

 (:init
   (atloc food1 texaco1)
   (atloc food3 texaco1)
   (atloc food2 henrietta-dump)
   (atloc pcrew1 pittsford-plaza)
   (atloc ttdriver1 rochester-general)
   (atloc dtruck1 strong)
   (atloc emt1 texaco1)
   (atloc pu2 texaco1)
   (atloc pu1 brighton-dump)
   (atloc bdriver1 twelve-corners)
   (atloc plow1 marketplace)
   (atloc sleader3 twelve-corners)
   (atloc sleader2 pittsford-plaza)
   (atloc gen1 pittsford-plaza)
   (atloc sleader1 rochester-general)
   (atloc gen2 marketplace)
   (atloc plow2 rochester-general)
   (atloc amb1 texaco1)
   (atloc van1 pittsford-plaza)
   (atloc wtruck1 park-ridge)
   (atloc bus1 twelve-corners)
   (atloc wcrew1 park-ridge)
   (atloc pdriver2 airport)
   (atloc pdriver1 park-ridge)
   (atloc ttruck1 rochester-general)
   (atloc ht1 brighton-dump)
   (atloc tcrew1 rochester-general)
   (atloc ht2 airport)
   (atloc tdriver1 strong)
   (atloc backhoe1 pittsford-plaza)
   (atloc ccrew1 pittsford-plaza)
   (atloc pvan2 texaco1)
   (atloc pvan1 brighton-dump)
   ;;
