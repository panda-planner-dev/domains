...
;; (:htn :tasks (tlt)) ;; generic tlt
 (:htn :tasks (set-up-shelter twelve-corners)) ;; org. tlt

 (:init
   (atloc food1 strong)
   (atloc food3 pittsford-plaza)
   (atloc food2 brighton-dump)
   (atloc pcrew1 texaco1)
   (atloc ttdriver1 strong)
   (atloc dtruck1 henrietta-dump)
   (atloc emt1 mendon-pond)
   (atloc pu2 twelve-corners)
   (atloc pu1 henrietta-dump)
   (atloc bdriver1 texaco1)
   (atloc plow1 brighton-high)
   (atloc sleader3 twelve-corners)
   (atloc sleader2 henrietta-dump)
   (atloc gen1 brighton-high)
   (atloc sleader1 texaco1)
   (atloc gen2 park-ridge)
   (atloc plow2 henrietta-dump)
   (atloc amb1 mendon-pond)
   (atloc van1 texaco1)
   (atloc wtruck1 twelve-corners)
   (atloc bus1 texaco1)
   (atloc wcrew1 twelve-corners)
   (atloc pdriver2 brighton-dump)
   (atloc pdriver1 mendon-pond)
