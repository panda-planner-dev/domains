(define (problem transport1)
 ...
 (:objects
  ...
  ;;
  person-158199 - person
 )

;; (:htn :tasks (tlt)) ;; generic tlt
 (:htn :tasks (provide-temp-heat person-158199)) ;; org. tlt

 (:init
   (fit-in person-158199 plow2)
   (fit-in person-158199 plow1)
   (fit-in person-158199 ttruck1)
   (fit-in person-158199 pvan2)
   (fit-in person-158199 pvan1)
   (fit-in person-158199 van1)
   (fit-in person-158199 dtruck1)
   (fit-in person-158199 bus1)
   (fit-in person-158199 amb1)
   (fit-in person-158199 wtruck1)
   (fit-in person-158199 backhoe1)
   (can-lift emt1 person-158199)
   (atloc food1 strong)
   (atloc food3 brighton-dump)
   (atloc food2 pittsford-plaza)
   (atloc pcrew1 brighton-high)
   (atloc ttdriver1 brighton-dump)
   (atloc dtruck1 marketplace)
   (atloc emt1 twelve-corners)
   (atloc pu2 pittsford-plaza)
   (atloc pu1 mendon-pond)
   (atloc bdriver1 brighton-high)
   (atloc plow1 mendon-pond)
   (atloc sleader3 texaco1)
   (atloc sleader2 airport)
   (atloc gen1 twelve-corners)
   (atloc sleader1 park-ridge)
   (atloc gen2 mendon-pond)
   (atloc plow2 texaco1)
   (atloc amb1 twelve-corners)
   (atloc van1 brighton-high)
   (atloc wtruck1 park-ridge)
   (atloc bus1 brighton-high)
   (atloc wcrew1 park-ridge)
   (atloc pdriver2 marketplace)
   (atloc pdriver1 henrietta-dump)
   (atloc ttruck1 brighton-dump)
   (atloc ht1 brighton-high)
   (atloc tcrew1 brighton-dump)
   (atloc ht2 brighton-dump)
   (atloc tdriver1 marketplace)
   (atloc backhoe1 airport)
   (atloc person-158199 brighton-dump)
   (atloc ccrew1 airport)
   (atloc pvan2 pittsford-plaza)
   (atloc pvan1 mendon-pond)
   ;;
